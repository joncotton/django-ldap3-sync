...
# LDAP_SYNC Configuration
LDAP_CONFIG = {
    'page_size': 100,
    'bind_user': 'LDAPBinder',
    'bind_password': '5tm0NICa5198SIx',
    'servers': [
        {'address': '10.192.81.55', 'port': 389, 'use_ssl': False, 'timeout': 30},
        {'address': '10.192.81.54', 'port': 389, 'use_ssl': False, 'timeout': 30},
    ]
...
LDAP_SYNC_GROUP_FILTER = "(&(objectClass=group)(|(sAMAccountName=*_STAFF_*)(sAMAccountName=*_STUDENT_*)))"
